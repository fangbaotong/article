...
* @website #kindsoft.net/
* @licence #kindsoft.net/license.php
...
_plugin('core', function(K) {
	...
	self.clickToolbar('about', function() {
		var html = '<div style="margin:20px;">' +
			...
			'<div>Copyright &copy; <a href="#kindsoft.net/" target="_blank">kindsoft.net</a> All rights reserved.</div>' +
			'</div>';
		self.createDialog({
			name : 'about',
			width : 350,
...
/**
 * SWFUpload: #swfupload.org, http://swfupload.googlecode.com
 *
 * mmSWFUpload 1.0: Flash upload dialog - http://profandesign.se/swfupload/,  #vinterwebb.se/
 *
...
SWFUpload.prototype.getFlashHTML = function () {
	// Flash Satay object syntax: #alistapart.com/articles/flashsatay
	// Fix bug for IE9
	// #kindsoft.net/view.php?bbsid=7&postid=5825&pagenum=1
	var classid = '';
